...
/**
 Error code specific to GCKeychain that can be returned in NSError objects.
 For codes returned by the operating system, refer to SecBase.h for your platform.
 */
typedef enum {
    
	/** Some of the arguments were invalid. */
	GCKeychainErrorBadArguments = -1001,
    
} GCKeychainErrorCode;

extern NSString *const kGCKeychainErrorDomain;

/** Account name. */
extern NSString *const kGCKeychainAccountKey;
 ...
 */
extern NSString *const kGCKeychainCreatedAtKey;

/** Item class. */
extern NSString *const kGCKeychainClassKey;

/** Item description. */
extern NSString *const kGCKeychainDescriptionKey;

/** Item label. */
extern NSString *const kGCKeychainLabelKey;

/** Time the item was last modified.
 
 The value will be a string.
 */
extern NSString *const kGCKeychainLastModifiedKey;

/** Where the item was created. */
extern NSString *const kGCKeychainWhereKey;
...
/**
 ...
 GCKeychain has since switched to a simpler implementation that was abstracted from [SSToolkit](http://sstoolk.it).
 */
...
/**
 ...
 See the `NSString` constants declared in GCKeychain.h for a list of keys that can be used when accessing the
