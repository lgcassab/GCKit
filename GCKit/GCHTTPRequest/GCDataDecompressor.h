...
// This is a helper class used by GCHTTPRequest to handle inflating (decompressing) data in memory and on disk
...
@interface GCDataDecompressor : NSObject {
	BOOL streamReady;
	z_stream zStream;
}
