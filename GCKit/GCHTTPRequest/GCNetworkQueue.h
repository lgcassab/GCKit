...
#import "GCHTTPRequestDelegate.h"
#import "GCProgressDelegate.h"

@interface GCNetworkQueue : NSOperationQueue <GCProgressDelegate, GCHTTPRequestDelegate, NSCopying> {
...
// All GCNetworkQueues are paused when created so that total size can be calculated before the queue starts
